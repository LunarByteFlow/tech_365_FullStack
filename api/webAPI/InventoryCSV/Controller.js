...
function determineTableType(row) {
  if (row.InventoryAO_ID) return "AO";
    ...
    case "AO":
      return {
        ...
        inputs: [
          ...
          { name: "Screen_Size", type: sqlTypes.VarChar, value: row.Screen_Size },
          ...
          { name: "QTY_Recieved", type: sqlTypes.Int, value: Number(row.QTY_Recieved) },
          { name: "QTY_On_Hand", type: sqlTypes.Int, value: Number(row.QTY_On_Hand) },
        ]
      };
